...
if __name__ == "__main__":
    ...
    "Summary of Findings Model Performance & Evaluation The Logistic Regression model achieved an Accuracy of 83.67% and a Recall of 83.67%."
    "In this imbalanced dataset (16% churn),the high recall is the most vital metric as it ensures the company identifies the majority of customers at risk of leaving."
    "The Ridge Regression model performed well with an R² of 0.7148, indicating a strong correlation between the selected features and the monthly charges."
    "Feature Importance & Regularization Through the Lasso comparison, it was observed that features such as gender were driven to zero,suggesting they are uninformative for predicting monthly_charges."
    "Conversely, contract_type and internet_service remained significant features in both models."
    "The use of StandardScaler was essential here to ensure that high-value features like total_charges did not disproportionately influence the weights compared to tenure. Recommended Next Steps To improve the classification model, "
    "I recommend investigating the high number of false positives (reflected in the lower 0.70 precision)."
    "Future iterations could benefit from Polynomial Features to capture non-linear relationships between tenure and monthly billing, or exploring Tree-based models like Random Forest to see if they handle the categorical feature interactions more effectively than Logistic Regression."